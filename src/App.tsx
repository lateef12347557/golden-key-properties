...
<a class="fab-whatsapp" href="https://wa.me/2349032299242?text=Hello%20Sabiosita%20Properties%2C%20I%20need%20help%20with%20a%20property." target="_blank" rel="noopener" aria-label="WhatsApp">
...
/* ============================================================
   SMALL-VIEW RESPONSIVE OVERRIDES (<=640px / <=420px)
============================================================ */
@media (max-width:640px){
  :root{ --nav-h:64px; }
  section{ padding: 3rem 0; }
  .container{ width:min(1240px, 94%); }
  .nav-inner{ width:min(1320px, 94%); }
  ...
  .search-card{ padding:.8rem; border-radius:18px; }
  .section-title{ font-size: 1.7rem; }
  .prop-grid{ grid-template-columns: 1fr !important; gap: 1rem; }
  .prop-grid .featured-card{ grid-column: span 1 !important; }
  .filter-pills{ flex-wrap: nowrap; overflow-x:auto; -webkit-overflow-scrolling:touch; padding-bottom:.4rem; }
  .filter-pills::-webkit-scrollbar{ display:none; }
  .pill{ flex-shrink:0; }
  .trust-inner{ gap:1.2rem 1rem; }
  .trust-num{ font-size:1.3rem; }
  .trust-label{ font-size:.65rem; letter-spacing:.1em; }
  .mobile-menu{ padding: calc(var(--nav-h) + 1.5rem) 7% 1.5rem; }
  .mobile-menu .mlinks a{ font-size:1.55rem; }
  .fab-whatsapp{ width:56px; height:56px; bottom:18px; right:16px; }
  .fab-top{ bottom:84px; right:16px; }
  .btn{ padding:.85rem 1.3rem; font-size:.95rem; }
  iframe{ max-width:100%; height:280px !important; }
  .modal{ width: 94vw !important; max-width: 94vw !important; padding:1.2rem !important; }
  img{ height:auto; }
...
@media (max-width:420px){
  ...
  .hero-l2{ font-size: clamp(2.2rem,11vw,3rem); }
  .hero-l1{ font-size: clamp(1.4rem,7vw,1.9rem); }
}
