...
<a class="fab-whatsapp" href="https://wa.me/2348100000000?text=Hello%20Hassan%20Real%20Estate%2C%20I%20need%20help%20with%20a%20property." target="_blank" rel="noopener" aria-label="WhatsApp">
...
export const Route = createFileRoute('/')({
  ...
  head: () => ({
    meta: [
      ...
      { property: 'og:site_name', content: 'Hassan Real Estate' },
      { property: 'og:type', content: 'website' },
      { property: 'og:title', content: 'Hassan Real Estate | Buy, Sell & Rent Properties in Nigeria' },
      ...
      { name: 'twitter:title', content: 'Hassan Real Estate' },
    ...
    links: [
      { rel: 'canonical', href: 'https://hassanrealestate.com/' },
